...
public class GuideHeaderController {
    ...
    public Result<GuideHeader> save(@RequestBody GuideHeader guideHeader) {
        // 判断是否重复
    ...
    public Result<GuideHeader> update(@RequestBody GuideHeader guideHeader) {
        ...
        guideHeaderService.delete(guideHeader.getCode());
        return ResultUtil.success(guideHeaderService.save(guideHeader));
    }
